...
<head>
        ...
        <!-- jQuery 2.2.3 -->
        <script src="{{asset('theme/admin/plugins/jQuery/jquery-2.2.3.min.js')}}"></script>
        <!-- Bootstrap 3.3.6 -->
        <script src="{{asset('theme/admin/bootstrap/js/bootstrap.min.js')}}"></script>

        <!-- Validations -->
        <script src="{{asset('theme/admin/plugins/jquery-validation/js/jquery.validate.min.js')}}"></script>
        <script src="{{asset('theme/admin/plugins/jquery-validation/js/additional-methods.min.js')}}"></script>
        <script src="{{asset('theme/admin/plugins/jquery-validation/js/jquery.validate.min.js')}}"></script>
        <script src="{{asset('theme/admin/plugins/jquery-validation/js/additional-methods.min.js')}}"></script>
