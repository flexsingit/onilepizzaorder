...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Pizza Category</li>
    </ol>
</section>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h2 class="box-title">Pizza Category</h2>
                    <a href="{{\App\Facades\Tools::createdAdminEndUrl('pizza/category/form')}}" class="btn btn-info pull-right" style="margin-bottom: 20px">{{__('Add New Admin')}}</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
...
<script type="text/javascript">
    ...
    generateDatatable({
        ...
        url: "{{\App\Facades\Tools::createdAdminEndUrl('pizza/category/list/ajax')}}",
        number_of_columns: 7,
        searching: true,
        columnDefs: [
            {name: 'id', targets: 0},
            {name: 'name', targets: 1},
            {name: 'image', targets: 2},
    ...
    function ChangeStatus(id) {
        $.ajax({
            type: 'GET',
            url: '{{\App\Facades\Tools::createdAdminEndUrl("pizza/category/change/status")}}' + '/' + id,
            dataType: 'json',
